...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,7],$V1=[1,3],$V2=[1,4],$V3=[1,5],$V4=[1,6],$V5=[1,9],$V6=[1,10],$V7=[1,11],$V8=[1,12],$V9=[1,13],$Va=[1,14],$Vb=[5,7,8,9,10,11,13,16,18];
...
},{"./grammar":1,"pluralize":3}],3:[function(require,module,exports){
/* global define */
