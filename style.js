...
$(document).ready(function(){
  ...
  example && $('#header').append('<div class="ribbon left red"><a href="' + example + '">Clone me on GitHub</a></div>');
  example && $('#header').append('<div class="ribbon right red"><a href="' + example + '">Clone me on GitHub</a></div>');

  $('#footer').html('<br /><div class="footer-strap">' +
  '<div class="footer-content">' +
    '<ul class="footer-links">' +
      (example? '<li><a href="' + example + '">Clone example on Github</a> | </li>' : '') +
